  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="日期" prop="createdAt" width="180">
          ...
          <el-table-column align="left" label="服务器名" prop="serverName" width="120" />
        <el-table-column align="left" label="服务器类型" prop="serverType" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.serverType,system TypeOptions) }}
            </template>
        </el-table-column>
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="查看">
            <el-descriptions :column="1" border>
                    <el-descriptions-item label="服务器名">
                        {{ detailFrom.serverName }}
                    </el-descriptions-item>
                    <el-descriptions-item label="服务器类型">
                        {{ detailFrom.serverType }}
                    </el-descriptions-item>
